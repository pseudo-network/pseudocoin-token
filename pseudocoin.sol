...
contract PseudoCoin is Context, IERC20, Ownable {
    ...
    string private _name = "PseudoCoin";
    ...
    uint256 public _maxTxAmount = .05 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = .005 * 10**6 * 10**9;
